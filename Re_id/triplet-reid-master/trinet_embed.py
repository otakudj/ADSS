...
seq_name=os.listdir('/home/cgv841/otakudj/MOT/Data/2DMOT2015/train/')
weight_fname = sys.argv[1]
r = [1,2,4,5,6,9,10]
for i in r:
    print(seq_name[i],end="...")
    image_list = list(map(str.strip, open('file/'+seq_name[i]+'.txt').readlines()))
    ...
    with open(seq_name[i] + '.txt', 'w') as f:
