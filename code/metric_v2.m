function res=metric_v2(name,pattern,visual_det,visual_res)
warning off;
global param;
% param.overlap=0.2;
% param.re_id=20;
param.articulated_num=6;
param.articulated_rate=0.5;
% param.del=0.8;
param.tao=50;
...
if visual_det==1
    k=1;
    for i=1:length(len)
        full_path=fullfile('../../MOT/Data/2DMOT2015/train',name,'img1');
